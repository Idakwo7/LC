...
export default function OurApproach() {
  return (
    <section className="relative md:pt-20 py-[42.16px] md:h-auto bg-[#FFFDF7] ">
      <Image
        src="/images/about-us/cash.svg"
        alt="cash"
        width={550}
        height={583}
        className="absolute lg:-top-60 -top-20 right-0  w-[200px] md:w-auto object-contain object-right"
        priority
      />
      ...
      <div className="bg-[#FFFDF7] h-full  md:pt-25 pt-5 pl-6 pr-[62px]">
        ...
        <div className="md:pl-30">
          ...
          <div className=" relative -top-4 bg-[#80CD75] md:gap-[8px] shrink-0 inline-flex items-center justify-center md:py-[12px] px-[8px] md:pr-[24px] md:pl-[8px] lg:pr-[40px] lg:pl-[16px] bg-80CD75 lg:h-[136px] rounded-[4px] md:rounded-[8px] h-[52px]">
            <h2
              className="  text-[52px] md:text-[146.7px] text-[#FFFFFF] md:-tracking-[7.88px] font-medium italic font-cormorant uppercase w-fit leading-[28px] md:leading-[117px] -tracking-[1.74]"
          ...
          <Image
            ...
            width={47}
            height={53}
            className="relative lg:-top-23 lg:left-173 w-[22px] md:w-auto -top-22 left-50"
          />
        </div>
        <div className=" lg:ml-[51%] lg:mr-[11.8%] lg:w-[564px]  border-t-1 pt-12 md:pt-16 ">
          <p className="text-[16px] md:text-[28px] lg:mt-6 md:mb-[106.5px] ml-[21px] mr-[83px] leading-[140%] -tracking-[0.33px]">
            At Live Capital, we have a unique approach to funding — embracing
            the crazy and the unconventional.
          </p>
        </div>
      </div>
      <div className=" md:mx-30 mx-6 pt-30 ">
        <div className="flex flex-col lg:flex-row items-center justify-center ">
          <div className="relative bg-[#FCF6EA] min-w-[330px] h-[410px] -rotate-[5.46deg] px-[37.2px] py-[28.05px] border-[2px] border-[#F7F9FC] rounded-[24px] z-0">
            <Image
          ...
          <div className="lg:-top-[26px] lg:-left-[26px] bg-[#FFE9F4] min-w-[330px] h-[410px] p-[37.2px] py-[28.05px] border-[2px] border-[#F7F9FC] rounded-[24px] z-10">
            <Image
          ...
          <div className="lg:top-[60.17px] lg:-left-[60px] bg-[#E9EFFF] min-w-[330px] h-[410px] rotate-[5deg] px-[37.2px] py-[28.05px] border-[2px] border-[#F7F9FC] rounded-[24px] z-20">
            <Image
          ...
          <div className="lg:-top-[1.57px] lg:-left-[90px] bg-[#68DACB] min-w-[330px] h-[410px] rotate-[6.5deg] px-[37.2px] py-[28.05px] border-[2px] border-[#F7F9FC] rounded-[24px] z-30">
            <Image
          ...
          <div className="lg:top-[19.15px] lg:-left-[140px] bg-[#162D67] min-w-[330px] h-[410px] -rotate-[5.46deg] px-[37.2px] py-[28.05px] border-[2px] border-[#F7F9FC] rounded-[24px] z-40">
            <Image
            ...
            />
            <div className="w-[248.91px]">
              <h2 className="text-[24px] font-bold text-[#FFFFFF]">Yield</h2>
              <p className="text-[16px] font-medium mt-[4.56px] text-[#FFFFFF]">
